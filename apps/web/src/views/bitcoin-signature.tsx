        ...
        <Counterexample
          en={
            <>
              ...
              uniformly random nonce <span className="font-mono">k</span> for every signature. Reuse{" "}
              <span className="font-mono">k</span> across two different messages and an attacker
              recovers <span className="font-mono">d</span> with eighth-grade algebra:{" "}
          ...
          ko={
            <>
              ...
              <span className="font-mono">k</span>를 재사용했고, *마스터 서명 키*가 며칠 만에 떨어져
              나왔다. 비트코인 지갑도 RNG가 살짝 어긋난 같은 방식으로 코인을 잃었다. 이산로그 격차는
              수학으로 깰 수 없지만, nonce는 코드로 깰 수 있다.
            </>
          }
        />
      </ArcRow>
      ...
      <WhyNotTaught
        en={
          <>
            ...
            reader to accept it. Lemma walks the door the other way: <em>why</em> would the verifier
            ever arrive at <span className="font-mono">R</span> without knowing{" "}
            <span className="font-mono">d</span>? The answer rebuilds the algebra from the one-way
            street (multiply easy, divide hard) up. The textbook hides the asymmetry; the asymmetry
            is the point.
          </>
        }
        ko={
