...
시스템 검증 단계. 2026년 5월 현재, Lemma에는 네 기둥 전체에 걸친 공개 응용 다섯 개, 공유 모듈 세 개가 있고, 모든 모듈은 적어도 하나의 응용에 의해 소비됩니다. 그래프는 더 이상 희망사항이 아닙니다. 금융, 그래픽, ML, 물리 모두에 위젯, 코드 모드, 손풀이 문제, 이중언어 용어집을 갖춘 진입점이 있습니다.

아직 초기입니다. 수학의 대부분은 여전히 비어 있습니다. 하지만 이 매니페스토의 핵심 약속 — 추상보다 응용, 시각적 직관과 손풀이, 두 모드, 모듈 그래프, 용어 단위의 이중언어 백필 — 은 이제 작동하는 예시를 갖고 있습니다.
